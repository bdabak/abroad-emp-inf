sap.ui.define([], function () {
    ...
    return {
        ...
        decideDocumentIcon: function(sExt){
            if(_documentTypes[sExt] && _documentTypes[sExt][0] !== undefined && _documentTypes[sExt][0] !== null ){
        ...
        decideDocumentIconColor: function(sExt){
            if(_documentTypes[sExt] && _documentTypes[sExt][1] !== undefined && _documentTypes[sExt][1] !== null ){
