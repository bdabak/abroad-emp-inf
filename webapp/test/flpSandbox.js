		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comthyuxabroadempinf-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comthyuxabroadempinf-display": {
								"semanticObject": "comthyuxabroadempinf",
								"action": "display",
								"description": "Yurt Dışı - Çalışan Bilgileri",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.thy.ux.abroadempinf",
									"url": sap.ui.require.toUrl("com/thy/ux/abroadempinf")
								}
							}
						}
					}
